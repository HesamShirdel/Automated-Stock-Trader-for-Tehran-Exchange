...
#***********************************************************
    ...
    def Moving_Average(path_data):
        ...
        for files in allFiles :
            ...
            stock1=stock1.set_index(pd.Dattime_endIndex(stock1['<DTYYYYMMDD>'].values))
...
#***********************************************************    
    ...
    def Buy(stock,price,volume):
        ...
        chrome_options.add_argument("--user-data-dir=C:\\Users\\Hesam\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 1")
        ...
        #check Balance
        time.sleep(3)
        balance=driver.find_element_by_xpath('/html/body/app-root/main-layout/main/div[3]/div/div/div/market-data/div/div[2]/div/span[2]').text
        ...
        if balance>(1.06*money):
            ...
            #time.sleep(2)
            driver.implicitly_wait(10)
            search=driver.find_element_by_xpath('/html/body/app-root/main-layout/main/d-search-management/search-panel/div/div[1]/input')
            search.click()
            search.clear()
            search.send_keys(stock)
            driver.implicitly_wait(10)
            #time.sleep(2)
            driver.find_element_by_xpath('/html/body/app-root/main-layout/main/d-search-management/search-panel/div/div[2]/div[2]/div/div[1]/div/div[contains(text(),stock)]').click()

            driver.implicitly_wait(10)
            #time.sleep(2)
            driver.find_element_by_xpath('/html/body/app-root/main-layout/main/div[3]/div/div/as-split/as-split-area/app-layout-selector/app-layout2/as-split/as-split-area[2]/div/div[1]/div/button[1]').click()
            #time.sleep(2)
            
            driver.implicitly_wait(10)                                
            vol=driver.find_element_by_xpath('/html/body/app-root/main-layout/main/div[3]/d-order-list/div/div[2]/div/order-form/div/div/form/div[1]/div[1]/div/dx-number-box/div/div[1]/input')
            vol.click()
            vol.clear()
            ...
            driver.implicitly_wait(10)
            pri=driver.find_element_by_xpath('/html/body/app-root/main-layout/main/div[3]/d-order-list/div/div[2]/div/order-form/div/div/form/div[1]/div[2]/div/dx-number-box/div/div[1]/input')
            pri.click()
            pri.clear()
            pri.send_keys(price)
            #time.sleep(2)
...
#************************************************************    
    ...
    def Sell(stock,price,volume):
        ...
        #Sell form
        #time.sleep(2)
        driver.find_element_by_xpath('/html/body/app-root/main-layout/main/div[3]/div/div/as-split/as-split-area/app-layout-selector/app-layout2/as-split/as-split-area[2]/div/div[1]/div/button[2]').click()
        #time.sleep(2)

        #volume
        vol=driver.find_element_by_xpath('/html/body/app-root/main-layout/main/div[3]/d-order-list/div/div[2]/div[1]/order-form/div/div/form/div[1]/div[1]/div/dx-number-box/div/div[1]/input')
        vol.click()
        vol.clear()
        vol.send_keys(volume)
        #time.sleep(2)
        ...
        #price
        pri=driver.find_element_by_xpath('/html/body/app-root/main-layout/main/div[3]/d-order-list/div/div[2]/div[1]/order-form/div/div/form/div[1]/div[2]/div/dx-number-box/div/div[1]/input')
        pri.click()
        pri.clear()
        pri.send_keys(price)
        #time.sleep(2)
...
#************************************************************  
    ...
    def Watch_Buy(Target,order_price):
        


        if order_price>=0.999*Target and order_price<=1.01*Target :
            
            c_options = webdriver.ChromeOptions()
            c_options.add_argument("headless")
            #c_options.add_argument("disable-gpu")
            c_options.add_argument("--user-data-dir=C:\\Users\\Hesam\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 1")
            ...
            try:
                ...
                chdriver.find_element_by_xpath('/html/body/div[5]/section/div/div/div/div[2]/table/tbody/tr[1]/td[1]/a[contains(text(),Stock)]').click()
                chdriver.implicitly_wait(30)
                time.sleep(15)

                hagigi_buy=chdriver.find_element_by_xpath('/html/body/div[4]/form/div[3]/div[2]/div[1]/div[4]/div[1]/table/tbody/tr[2]/td[2]/div[1]').text
                hagigi_buy=hagigi_buy.replace(",","")
                hagigi_buy=hagigi_buy.replace("M","")
                hagigi_buy_flo = float(hagigi_buy)


                hagigi_sell=chdriver.find_element_by_xpath('/html/body/div[4]/form/div[3]/div[2]/div[1]/div[4]/div[1]/table/tbody/tr[2]/td[3]/div[1]').text
...
#************************************************************ 
    ...
    def Watch_Sell(Target,ma,order_price):
             
        
            


        if order_price!=0 and order_price>= math.ceil(0.95*(Price_list.loc[Price_list[Naam]==Stock , Dirooz].item())):
